...
// 이 경우 원본 데이터가 변경된다.
// 깊은복사(원본 변경 후가 표시됨) 얕은복사(원본 변경 전이 표시됨)
arr.push('add data');
// console.log(arr);
...
arr[5] = '5번 추가';
// console.log(arr);
// arr[10] = '11번 추가'; // 값이 없는 사이는 empty로 나오고 값은 undefined임
// console.log(arr);
// console.log(arr[7]); // undefined(오류아님!!!)
...
// signiture : array.splice( index : 없애고 싶은 index, length of remove data)
...
// 문자열을 읽고, 특정 문자를 기준으로 두 개의 배열을 생성한다.
...
const spredArr = [3, 5, 7, 9];
const ssa = [...spredArr, 1, 2];
console.log(ssa);
