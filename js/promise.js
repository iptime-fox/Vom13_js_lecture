...
// promise는 데이터 처리에 성공했을때 실행할 콜백 함수와 성공하지 않았을 때 실행할 콜백 함수를 미리 정하는(promise) 것이다.(값이다)
...
// console.log(getData); // reject : rejected, resolve : fulfilled, 정의되지 않은 프로미스 : pending
