...
//  : 선택객체.addEventListener('click', function (){
// 4. 숫자 증가
...
// 키보드 키코드는 구글에 keycode 검색해서 활용. enter는 13번임!
...
toTop.addEventListener('click', function () {
  ...
  // this.style.background = 'rgb(255, 181, 181)';
});
...
hoverEl.addEventListener('mouseenter', function () {
  this.style.background = 'rgb(255, 255, 144)';
});
